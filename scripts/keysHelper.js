const keyCodeByKey = { 
    "1": {key:"1",keyCode:"49", neighbors: ["2", "A"], leftNeighbors: ["A"], rightNeighbors:  ["2", "A"]},
    "2": {key:"2",keyCode:"50", neighbors: ["1", "3", "A", "Z"], leftNeighbors: ["1", "A", "Z"], rightNeighbors: ["3", "A", "Z" ]},
    "3": {key:"3",keyCode:"51", neighbors: ["2", "4", "Z", "E"], leftNeighbors: ["2", "Z", "E"], rightNeighbors: ["4", "Z", "E"]},
    "4": {key:"4",keyCode:"52", neighbors: ["3", "5", "E", "R"], leftNeighbors: ["3", "E", "R"], rightNeighbors: ["5", "E", "R"]},
    "5": {key:"5",keyCode:"53", neighbors: ["4", "6", "R", "T"], leftNeighbors: ["4", "R", "T"], rightNeighbors: ["6", "R", "T"]},
    "6": {key:"6",keyCode:"54", neighbors: ["5", "7", "T", "Y"], leftNeighbors: ["5", "T", "Y"], rightNeighbors: ["7", "T", "Y"]},
    "7": {key:"7",keyCode:"55", neighbors: ["6", "8", "Y", "U"], leftNeighbors: ["6", "Y", "U"], rightNeighbors: ["8", "Y", "U"]},
    "8": {key:"8",keyCode:"56", neighbors: ["7", "9", "U", "I"], leftNeighbors: ["7", "U", "I"], rightNeighbors: ["9", "U", "I"]},
    "9": {key:"9",keyCode:"57", neighbors: ["8", "0", "I", "O"], leftNeighbors: ["8", "I", "O"], rightNeighbors: ["0", "I", "O"]},
    "0": {key:"0",keyCode:"48", neighbors: ["9", "°", "O", "P"], leftNeighbors: ["9", "O", "P"], rightNeighbors: ["°", "O", "P"]},
    "°": {key:"°",keyCode:"219", neighbors: ["0", "+", "P", "¨"], leftNeighbors: ["0", "P", "¨"], rightNeighbors: ["+", "P", "¨"]},
    "+": {key:"+",keyCode:"187", neighbors: ["°", "¨", "£"], leftNeighbors: ["°", "¨", "£"], rightNeighbors: ["¨","£"]},
    "A": {key:"A",keyCode:"65", neighbors: ["1", "2", "Z", "Q"], leftNeighbors: ["1","2", "Q"], rightNeighbors:  ["1","2", "Z", "Q"]},
    ...
    "Q": {key:"Q",keyCode:"81", neighbors: ["A", "Z", "S",">", "W"], leftNeighbors: ["A", "Z", ">", "W"], rightNeighbors:  ["S","A", "Z", ">", "W", "S"]},
    "S": {key:"S",keyCode:"83", neighbors: ["Z", "E", "Q","D", "W", "X"], leftNeighbors: ["Q","Z", "E", "W", "X"], rightNeighbors:  ["D","Z", "E", "W", "X", "D"]},
    "D": {key:"D",keyCode:"68", neighbors: ["E", "R", "S","F", "X", "C"], leftNeighbors: ["S","E", "R", "X", "C"], rightNeighbors:  ["F","E", "R", "X", "C", "F"]},
    "F": {key:"F",keyCode:"70", neighbors: ["R", "T", "D","G", "C", "V"], leftNeighbors: ["D","R", "T", "C", "V"], rightNeighbors:  ["G","R", "T", "C", "V", "G"]},
    "G": {key:"G",keyCode:"71", neighbors: ["T", "Y", "F","H", "V", "B"], leftNeighbors: ["F","T", "Y", "V", "B"], rightNeighbors:  ["H","T", "Y", "V", "B", "H"]},
    "H": {key:"H",keyCode:"72", neighbors: ["Y", "U", "G","J", "B", "N"], leftNeighbors: ["G","Y", "U", "B", "N"], rightNeighbors:  ["J","Y", "U", "B", "N", "J"]},
    "J": {key:"J",keyCode:"74", neighbors: ["U", "I", "H","K", "N", "?"], leftNeighbors: ["H","U", "I", "N", "?"], rightNeighbors:  ["K","U", "I", "N", "?", "K"]},
    "K": {key:"K",keyCode:"75", neighbors: ["I", "O", "J","L", "?", "."], leftNeighbors: ["J","I", "O", "?", "."], rightNeighbors:  ["L","I", "O", "?", ".", "L"]},
    "L": {key:"L",keyCode:"76", neighbors: ["O", "P", "K","M", ".", "/"], leftNeighbors: ["K","O", "P", ".", "/"], rightNeighbors:  ["M","O", "P", ".", "/", "M"]},
    "M": {key:"M",keyCode:"77", neighbors: ["P", "¨", "L","%", "/", "§"], leftNeighbors: ["L","P", "¨", "/", "§"], rightNeighbors:  ["%","P", "¨", "/", "§", "%"]},
    "%": {key:"%",keyCode:"192", neighbors: ["¨","£", "M","µ", "§" ], leftNeighbors: ["M","¨", "£", "M", "§"], rightNeighbors:  ["µ","¨", "£", "§", "µ"]},
